...
// meta_page中num_allocated_pages_和num_extents_用了8个byte 所以PAGE_SIZE - 8
// 假设使用extent_used_page_ 每1个uint32_t extent_used_page_[i]即4个byte 对应一个bitmap page 所以 / 4
// 每一个bitmap page可以控制的data page数量是GetMaxSupportedSize()
