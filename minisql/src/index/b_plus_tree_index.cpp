...
BPLUSTREE_INDEX_TYPE::BPlusTreeIndex(index_id_t index_id, IndexSchema *key_schema,
  ...
  auto page = reinterpret_cast<IndexRootsPage *>(buffer_pool_manager->FetchPage(1));
  page_id_t root_page_id;
  page->GetRootId(index_id, &root_page_id);
  container_.SetRootId(root_page_id);
  buffer_pool_manager->UnpinPage(1, false);
}
